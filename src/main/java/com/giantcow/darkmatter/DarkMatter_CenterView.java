...
public class DarkMatter_CenterView extends JComponent implements KeyListener, MouseListener {
    ...
    /**
     * set the zoom level depends on localplayer's size
     */
    private void zoom() {
        ...
        x = (int) (localPlayer.getCenterX()-5*localPlayer.getRadius()*DEFAULT_WIDTH/DEFAULT_HEIGHT);
        y = (int) (localPlayer.getCenterY()-5*localPlayer.getRadius());
    }
