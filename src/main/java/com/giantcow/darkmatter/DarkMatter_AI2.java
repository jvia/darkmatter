...
/**
 * This is the class used for test AI Player 2
 *
 * @author Jeremiah M. Via <jxv911@cs.bham.ac.uk>
 * @author Joss Greenaway  <jtg897@cs.bham.ac.uk>
 * @author Yukun Wang      <yxw999@cs.bham.ac.uk>
 */
public class DarkMatter_AI2 extends JComponent implements KeyListener, MouseListener, MouseWheelListener {
    ...
    public DarkMatter_AI2() {
        ...
        localPlayer.setScreen(DEFAULT_WIDTH, DEFAULT_HEIGHT);
    }
